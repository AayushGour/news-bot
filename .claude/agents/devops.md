...
tools: Read, Grep, Glob, Edit, Write, Bash, mcp__web-search__web_search, mcp__web-search__ensure_searxng, mcp__deepwiki__ask_question
model: sonnet
---
# DevOps  (dev mode)
...
4. Log 1 line → .claude/logs/devops.md (see CLAUDE.md logging). Record infra decisions in .claude/project-context.md.
